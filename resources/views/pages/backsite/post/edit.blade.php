        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <div class="row">
                        <form class="form form-horizontal" action="{{ route('post.update', $post->id) }}" method="POST"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-lg-10 col-9">
                                        <textarea name="content" class="form-control ckeditor-5" id="ckeditor5">{{ $post->content ?? old('content') }} </textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
